...
`home/user/voice.nix`. It matches the managed COSMIC Catppuccin
Macchiato/Lavender palette and JetBrains Mono font. This is an explicit theme,
not automatic following of arbitrary COSMIC light/dark or palette changes.
It does not replace the application launcher or run another daemon.
