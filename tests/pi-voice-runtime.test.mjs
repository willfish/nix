...
import { socketCall } from '../home/config/pi/extensions/subagent/herdr.js';
import { shellQuote } from '../home/config/pi/extensions/subagent/team.js';

const voiceSource = new URL('../home/config/pi/extensions/pi-voice.js', import.meta.url);
...
test('live Pi voice: startup, reload, new session, question guard and controller restart', {
  ...
  await writeFile(join(agent, 'extensions', 'pi-voice.js'), await readFile(voiceSource));
