...
import { searchCatalog, replaceSkillAdvertisement, BOOTSTRAP } from '../home/config/pi/extensions/skill-catalog/catalog.ts';
...
test('installed Pi exports formatter, loads extension and supplies trusted registry without command changes', { timeout: 30000 }, async t => {
  ...
  const policy = fileURLToPath(new URL('../home/config/pi/extensions/reading-policy.ts', import.meta.url));
