...
import { smokeModel } from './fixtures/pi-team-smoke-model.ts';
import { HerdrPanes, socketCall } from '../home/config/pi/extensions/subagent/herdr.ts';
import { TeamManager, shellQuote } from '../home/config/pi/extensions/subagent/team.ts';
import { withSkills } from '../home/config/pi/extensions/subagent/skills.ts';
