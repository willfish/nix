...
// PI_CONTEXT_TEST_BIN=pi node --test tests/pi-context-runtime.test.ts
...
test('real Pi changes context, keeps registry defaults, restores sessions and opens the picker', {
  ...
  try {
    ...
    child = spawn(binary, [
      ...
      '-e', process.env.PI_CONTEXT_TEST_EXTENSION ?? fileURLToPath(new URL('../home/config/pi/extensions/context-window.ts', import.meta.url)),
      '-e', fixture,
