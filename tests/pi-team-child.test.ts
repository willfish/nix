...
import childExtension from '../home/config/pi/extensions/subagent/child.ts';
import { atomicJson, command, envelope, prepareRun, readJson } from '../home/config/pi/extensions/subagent/protocol.ts';
