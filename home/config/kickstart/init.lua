...
vim.api.nvim_set_keymap('n', '<leader>p', '<cmd>lua insert_jira_ticket_number()<CR>',
...
require('lazy').setup({
    ...
    { -- Fuzzy Finder (files, lsp, etc)
      ...
      config = function()
        ...
        vim.keymap.set("n", "<Leader>fp", ":lua require('telescope').extensions.gh.pull_request()<CR>",
      ...
      config = function()
        ...
        vim.api.nvim_create_autocmd('LspAttach', {
          ...
          callback = function(event)
            ...
            map('<leader>gn', vim.lsp.buf.rename, '[G]o re[n]ame')

            -- Execute a code action, usually your cursor needs to be on top of an error
            -- or a suggestion from your LSP for this to activate.
            map('<leader>ga', vim.lsp.buf.code_action, '[G]o [a]ction', { 'n', 'x' })
