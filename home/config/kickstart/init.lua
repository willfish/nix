...
vim.api.nvim_set_keymap('n', '<leader>p', '<cmd>lua insert_jira_ticket_number()<CR>', { desc = "Inserts the current branch ticket number into the buffer" })
...
local lazypath = "$HOME/.config/lazy"
