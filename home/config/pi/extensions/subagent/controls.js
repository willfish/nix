import { formatJob } from './job-results.js';
...
Answer pending questions with team answer only from existing evidence. Use team ask when uncertain or when requiresUser is true: this asks the human in this main pane. Do not invent human approval. If a dialog is dismissed, leave the question pending and do not reopen it automatically.
