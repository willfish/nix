...
Each role pins model and thinking in agent frontmatter. Override with subagent model and thinking, or on a task/chain item; omitted values use the role then this session. Prefer xai/grok-4.6 and openai-codex/gpt-6-astra. Follow-up team send keeps the child's existing model.
